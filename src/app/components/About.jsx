      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <div><span className="text-gray-500">9 </span>    github: <span className="text-blue-400">"github.com/adnane-chaikhi"</span>,</div>
            <div><span className="text-gray-500">10</span>    email: <span className="text-blue-400">"codervdnane@gmail.com</span></div>
          ...
          <div className="mt-6 flex gap-5 text-2xl text-green-400">
            <a href="https://www.linkedin.com/in/adnane-chaikhi/" target="_blank" className="hover:text-lime-400"><FaLinkedin /></a>
            <a href="https://github.com/adnane-chaikhi" target="_blank" className="hover:text-lime-400"><FaGithub /></a>
            <a href="mailto:codervdnane@gmail.com" className="hover:text-lime-400"><FaEnvelope /></a>
          </div>
        </motion.div>
      </div>
    </section>
